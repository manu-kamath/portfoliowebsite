...
The part that genuinely surprised me was the Claude to Figma to code pipeline.
...
*Manu Kamath is a design leader with 12+ years across healthcare, e-commerce, ad-tech, and enterprise SaaS. He writes about design leadership, AI-native workflows, and building things on purpose.*
    `.trim(),
  },
];
